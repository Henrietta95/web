...
public class PageInterceptor implements Interceptor {
	 ...
	 * @return
	 */
	private String buildOrderSql(String sql) {
		if (PageContext.getSort() != null && PageContext.getOrder() != null) {
			StringBuilder orderSql = new StringBuilder(sql);
			orderSql.append(" order by " + PageContext.getSort() + " "
					+ PageContext.getOrder());
	...
	private String buildPageSql(String sql) {
		if (PageContext.getPageOffset() != null
				&& PageContext.getPageSize() != null) {
	...
	public StringBuilder buildPageSqlForMysql(String sql) {
		...
		String beginrow = String.valueOf((PageContext.getPageOffset() - 1)
	...
	public StringBuilder buildPageSqlForOracle(String sql) {
		...
		String beginrow = String.valueOf((PageContext.getPageOffset() - 1)
				* PageContext.getPageSize());
		String endrow = String.valueOf(PageContext.getPageOffset()
				* PageContext.getPageSize());
